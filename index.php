            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Cadastrar Cliente</h2>
                        <a href="create.php" class="btn btn-primary pull-right">Adicionar novo cliente</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['id'] . "</td>";
                                        echo "<td>" . $row['nome'] . "</td>";
                                        echo "<td>" . substr($row["telefone"],0,15) . "</td>";
                            ...
                            echo "<p class='lead'><em>Não há dados cadastrados.</em></p>";
                        }
                    } else{
